...
class InviteClass extends React.Component {
  componentDidMount() {
    this._LoginCheck();
  }
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View style={styles.mainHeader}>
          ...
          <Text style={styles.headingText}>Invite & Earn</Text>
        </View>
        <View
        ...
        <View style={styles.middelScreen}>
          ...
          />
          <Text style={styles.signinText}>Sign in to Refer & Earn rewards</Text>
          <Text style={styles.smallText}>
            Get your friends on OYO and Earn exciting reward
          </Text>
        </View>
